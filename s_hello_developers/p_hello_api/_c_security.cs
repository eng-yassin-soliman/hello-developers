...
namespace p_hello_api
{
    public class _c_security
    {
        ...
        /// </summary>
        /// <param name="p_msg_">Input messae as byte array</param>
        ...
        public static byte[] f_encrypt_(byte[] p_msg_)
        {
            ...
            l_tds_.Clear(); return l_out_;
        }
        ///<summary>
        ///Decrypts a byte array
        ///</summary>
        ///<param name="p_cpr_">Input cipher as byte array</param>
        ...
        public static byte[] f_decrypt_ (byte[] p_cpr_)
        {
            ...
            l_tds_.Mode = CipherMode.ECB;
            l_tds_.Padding = PaddingMode.PKCS7;
            ICryptoTransform l_dec_ = l_tds_.CreateDecryptor(); // Notice: (En-cryptor!)
                                                                // Decrypt
            ...
            {
                return new byte[] { }; }
            return l_out_.Skip(8).ToArray();                    // Remove padding      
        }
        ///<summary>
        ///Hashing a byte array
        ///</summary>
        ///<param name="p_inp_">Input as a byte array</param>
